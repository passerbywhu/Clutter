 ...
 */
public class LinearLayoutWithMeasureInfo extends LinearLayout {
    ...
    public LinearLayoutWithMeasureInfo(Context context) {
        super(context);
        setGravity(Gravity.CENTER);
        setPadding(PADDING, PADDING, PADDING, PADDING);
    }

    public LinearLayoutWithMeasureInfo(Context context, AttributeSet attrs) {
        super(context, attrs);
        setGravity(Gravity.CENTER);
        setPadding(PADDING, PADDING, PADDING, PADDING);
    }

    public LinearLayoutWithMeasureInfo(Context context, AttributeSet attrs, int defStyleAttr) {
